  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-4 max-w-4xl mx-auto mt-2">
      ...
      <div className="mt-6 sm:mt-8">
        <button className="bg-gradient-to-r from-[#E6D6C8] to-white text-black font-semibold font-sans rounded-xl px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base backdrop-blur-lg">
